      ...
      <View style={styles.container}>
        <View>
          ...
          <Text style={styles.caption}>
            Let’s log in to your account and find your favorite jersey :)
          </Text>
            ...
            <View>
              ...
              <View
                ...
                <TouchableOpacity onPress={togglePasswordVisibility}>
                  {passwordVisible ? (
                    <Eye variant="Linear" color={colors.darkred(0.6)} size={20} />
                  ) : (
                    <EyeSlash
                      variant="Linear"
        ...
        <View style={{ gap: 10 }}>
          ...
          <View style={{ flexDirection: 'row', gap: 5, alignSelf: 'center' }}>
            ...
            <TouchableOpacity onPress={() => navigation.navigate('Register')}>
              <Text style={[button.label, { color: colors.red(0.5) }]}>
                Sign up
              </Text>
            </TouchableOpacity>
          </View>
...
const textinput = StyleSheet.create({
  ...
  container: {
    backgroundColor: colors.red(0.05),
    height: 52,
